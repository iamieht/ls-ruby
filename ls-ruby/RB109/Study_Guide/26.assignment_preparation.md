...
In theory there are no primitive data types in Ruby, as everything can and should be treated as an object. The most common objects are: String, Integer, Float, Boolean, Array, Hash, nil, symbol, range 
