...
## [[RB109/Study_Guide/1.the_basics|The Basics]]
...
## [[22.loops_and_iterators|Loops and Iterators]]
...
## [[2.var_variables|Variables (General)]]

#### 1. What are variables?
#### 2. How to assign values to a variable?
#### 3. How the methods `get` and `chomp` work?
#### 4. What determines the variable scope?
#### 5. [[5.var_local_variable_scope_methods|Explain Local variable scope in relation to method definitions]]
...
#### 8. What is a block?
#### 9. [[6.var_local_variable_scope_blocks|Explain Local variable scope in relation to blocks, including nested blocks and peer blocks]]
#### 10. What are the rules of Local variable scope in relation to blocks?

## [[3.var_variables_as_pointers|Variables as Pointers]]
...
## [[4.var_variable_shadowing|Variable Shadowing]]

#### 1. What is variable shadowing?
#### 2. Examples

## [[7.var_scope_of_constants|Scope of Constants]]

#### 1. What kind of scope have constants?
#### 2. What are the scope rules for constants?

## [[8.var_mutating_values_vs_reassigning|Mutating values vs. Reassigning Variables]]
