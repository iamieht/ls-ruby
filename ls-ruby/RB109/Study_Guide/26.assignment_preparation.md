...
#### 5. [[4.var_local_variable_scope_methods|Explain Local variable scope in relation to method definitions]]
...
#### 8. What is a block?
#### 9. [[5.var_local_variable_scope_blocks|Explain Local variable scope in relation to blocks, including nested blocks and peer blocks]]
...
## [[6.var_scope_of_constants|Scope of Constants]]

#### 1. What kind of scope have constants?
#### 2. What are the scope rules for constants?

## [[7.var_mutating_values_vs_reassigning|Mutating values vs. Reassigning Variables]]
