...
#### 5. Explain Local variable scope in relation to method definitions
...
#### 8. What is a block?
#### 9. Explain Local variable scope in relation to blocks, including nested blocks and peer blocks
